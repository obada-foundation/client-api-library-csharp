...
namespace Obada.Client.Model
{
    ...
    public partial class LocalObit :  IEquatable<LocalObit>, IValidatableObject
    {
        ...
        public LocalObit(string owner = default(string), ObitStatusEnum obitStatus = default(ObitStatusEnum), string manufacturer = default(string), string partNumber = default(string), string serialNumber = default(string), List<LocalObitMetadataInner> metadata = default(List<LocalObitMetadataInner>), List<LocalObitDocumentsInner> documents = default(List<LocalObitDocumentsInner>), List<LocalObitStructuredDataInner> structuredData = default(List<LocalObitStructuredDataInner>), DateTime modifiedAt = default(DateTime))
        {
            ...
            if (modifiedAt == null)
            {
                throw new InvalidDataException("modifiedAt is a required property for LocalObit and cannot be null");
            }
            else
            {
        ...
        public List<LocalObitMetadataInner> Metadata { get; set; }
        ...
        public List<LocalObitDocumentsInner> Documents { get; set; }
        ...
        public List<LocalObitStructuredDataInner> StructuredData { get; set; }
