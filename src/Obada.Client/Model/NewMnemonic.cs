...
namespace Obada.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewMnemonic :  IEquatable<NewMnemonic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMnemonic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewMnemonic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewMnemonic" /> class.
        /// </summary>
        ...
        public NewMnemonic(string mnemonic = default(string), bool force = false)
        {
            // to ensure "mnemonic" is required (not null)
            if (mnemonic == null)
            {
                throw new InvalidDataException("mnemonic is a required property for NewMnemonic and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NewMnemonic);
        }

        /// <summary>
        /// Returns true if NewMnemonic instances are equal
        /// </summary>
        /// <param name="input">Instance of NewMnemonic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewMnemonic input)
        {
            if (input == null)
                return false;
