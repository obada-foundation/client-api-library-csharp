...
namespace Obada.Client.Model
{
    ...
    public partial class UnprocessableEntity :  IEquatable<UnprocessableEntity>, IValidatableObject
    {
        ...
        public UnprocessableEntity(string error = "data validation error", List<UnprocessableEntityFieldsInner> fields = default(List<UnprocessableEntityFieldsInner>))
        {
        ...
        public List<UnprocessableEntityFieldsInner> Fields { get; set; }
